...
class DevToolsPageTest extends TestCase
{
    ...
    {
        $this->get(route('dev-tools.runtime'))
            ->assertOk()
    ...
    {
        $this->get(route('dev-tools.cron-guru'))
            ->assertOk()
    ...
    {
        $this->get(route('dev-tools.image-compressor'))
            ->assertOk()
    ...
    {
        $this->get(route('dev-tools.deployments'))
            ->assertOk()
    ...
    {
        $this->get(route('dev-tools.hash-generator'))
            ->assertOk()
